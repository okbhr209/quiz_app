const questions = [
    {
        ...
        choices :["Rabindranath Tagore","Chandrasekhara Venkata Raman","Har Gobind Khorana","Sarvepalli Radhakrishnan"] ,
        correct : 1,
        desc:" conceptual" ,
    ...
    } ,
    {
        ...
        choices :["Godavari","Ganges","Indus","Cauveri"] ,
        correct : 2,
        desc:" Ganga is one of the longest rivers in India, which runs for a length of more than 2500 kilometres. It is also known as the Padma river in Bangladesh." ,
        image: "https://en.wikipedia.org/wiki/Ganges#/media/File:Varanasiganga.jpg",
    },
    {
        question:" What crop is famously grown in the region of Darjeeling?",
        choices :["Tea leaves","Wool","Islamabad"] ,
        correct : 1,
        desc:" conceptual" ,
        image: "None",
    } ,
    {
        ...
        choices :["Tiger","Elephant","Lion","Deer"] ,
        correct : 3,
        desc:" At present, Gir forests of Gujarat (India) is the only place where this race of lions i.e. Asiatic lion is found in its natural habitat. Unlike the other big cats, lion is tolerant of the presence of human being and it even lives near the human settlements." ,
        image: "https://en.wikipedia.org/wiki/Gir_National_Park#/media/File:Gir_lion-Gir_forest,junagadh,gujarat,india.jpeg",
    },
    {
        question:"Highest dam of India is? ",
        choices :["Bhakra Nangal Dam","Tehri Dam","Sardar Sarovar Dam","Hirakud Dam"] ,
        correct : 2,
        desc:" The Tehri Dam is India's largest dam and one of the world's tallest. It is a multi-purpose rock and earth-fill embankment dam near Tehri in Uttarakhand, India, on the Bhagirathi River." ,
        image: "None",
    } ,
